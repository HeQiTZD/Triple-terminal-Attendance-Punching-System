...
namespace {
struct qt_meta_tag_ZN13DeviceMonitorE_t {};
} // unnamed namespace

template <> constexpr inline auto DeviceMonitor::qt_create_metaobjectdata<qt_meta_tag_ZN13DeviceMonitorE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<DeviceMonitor, qt_meta_tag_ZN13DeviceMonitorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DeviceMonitor::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13DeviceMonitorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13DeviceMonitorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13DeviceMonitorE_t>.metaTypes,
    nullptr
} };
...
void *DeviceMonitor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13DeviceMonitorE_t>.strings))
