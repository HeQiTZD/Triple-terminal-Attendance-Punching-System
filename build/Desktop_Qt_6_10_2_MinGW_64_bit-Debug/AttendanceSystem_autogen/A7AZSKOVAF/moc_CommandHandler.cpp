...
void CommandHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CommandHandler::*)(const QJsonObject & )>(_a, &CommandHandler::sendMessage, 0))
            return;
...
// SIGNAL 0
void CommandHandler::sendMessage(const QJsonObject & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void CommandHandler::resyncRequested()
{
